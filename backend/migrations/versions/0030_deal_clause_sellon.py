...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("clause_type", sa.Enum("APPEARANCES", "GOALS", "PROMOTION", "RESALE", "OTHER", name="clausetype"), nullable=False),
        sa.Column("trigger_description", sa.Text(), nullable=False),
        sa.Column("amount", sa.Numeric(15, 2), nullable=False),
        sa.Column("cap", sa.Numeric(15, 2), nullable=True),
        sa.Column("status", sa.Enum("PENDING", "TRIGGERED", "PAID", name="clausestatus"), nullable=False, server_default="PENDING"),
